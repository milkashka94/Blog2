...
@section('title') Список постов @endsection
@section('content')
                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <td class="text-center"><a href ='{{route('profile.index', $post->author->name ?? 0)}}'>{{$post->author->name ?? "Неизвестен"}}</a></td>
