...
@section('title') Просмотр поста @endsection
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Просмотр удаленного поста</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{route('admin.garbage.posts.restore',$post->id)}}" method="POST" enctype='multipart/form-data'>
                                @csrf
                                @method('patch')
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <a href="{{route('admin.garbage.posts.restore', $post->id)}}" class="btn btn-success">Восстановить</a>
                                </div>
