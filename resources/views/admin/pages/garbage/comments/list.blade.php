...
@section('title') Удаленные комментарии @endsection
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Удаленные комментарии</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach($comments as $comment)
                                        <tr>
                                            ...
                                            <td class="text-center" width="300"><a href="{{route('posts.show', $comment->post->id)}}">{{$comment->post->title}}</a></td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu" style="">
                                                        <a class="dropdown-item"
                                                           href="{{ route('admin.garbage.comments.edit', $comment->id) }}">Редактировать</a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('admin.garbage.comments.restore', $comment->id) }}">Восстановить</a>
                                                        <form action="{{route('admin.garbage.comments.destroy', $comment->id)}}"
                                                              method="POST">
                                                            @method('DELETE')
                                                            @csrf
