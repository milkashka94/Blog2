...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <a href="{{route('admin.users.create')}}" class="btn btn-primary mb-2">Добавить</a><p>
            <div class="container-fluid">
                <!-- Content-->
                <div class="col-md-12">
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="{{route('profile.index', $user->name)}}">{{$user->name}}</a></td>
                                        ...
                                        <td class="text-center"><div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu" style="">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('admin.users.edit', $user->id) }}">Редактировать</a>
                                                    @endcheck
